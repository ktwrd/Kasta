...
namespace Kasta.Data.Migrations
{
    ...
    [Migration("20241229053432_AddTable_SystemMailboxMessage")]
    partial class AddTable_SystemMailboxMessage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kasta.Data.Models.UserApiKeyModel", b =>
                {
                    b.HasOne("Kasta.Data.Models.UserModel", "CreatedByUser")
                        .WithOne()
                        .HasForeignKey("Kasta.Data.Models.UserApiKeyModel", "CreatedByUserId");
